...
class Provider(BaseProvider):
	...
	async def chat(self, request: ChatRequest) -> ChatResponse:
		return ChatResponse(text="[openrouter stub] chat not implemented", tokens=TokenUsage())

	async def generate(self, request: GenerateRequest) -> GenerateResponse:
		return GenerateResponse(text="[openrouter stub] generate not implemented", tokens=TokenUsage())
	...
	async def models(self) -> list[ModelInfo]:
		return [ModelInfo(provider="openrouter", model="openrouter-model")]
